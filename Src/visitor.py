...
class TraductorArduinoVisitor(ArduinoMexaVisitor):
    ...
    def visitExpr(self, ctx: ArduinoMexaParser.ExprContext):
        # Si la regla 'expr' tiene más de un hijo, es una operación (+ o -)
